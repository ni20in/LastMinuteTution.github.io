  ...
  return (
    <>
      <div className="home" id="home">
        <main>
          <h1 Font-color="black">Last Minute Tution</h1>
      ...
      <div className="home2">
        ...
        <div>
          <p>
            Having difficulty finding free courses well Not anymore. We are leading tech company whose aim is to provide free premimum content to everyone.
          </p>
        </div>
      </div>
